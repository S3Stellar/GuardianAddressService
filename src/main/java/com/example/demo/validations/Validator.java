...
public class Validator {
	...
	public boolean validateAddress(AddressBoundary address) {
		return address.getCityAddress() != null &&
				address.getCityName() != null &&
				address.getLocation() != null &&
				!address.getCityAddress().isEmpty() &&
				!address.getCityName().isEmpty() &&
				address.getLocation().getLat() != 0 &&
	...
	public boolean validateCityName(AddressBoundary address) {
		return address.getCityName() != null &&
				!address.getCityName().isEmpty();
	}
